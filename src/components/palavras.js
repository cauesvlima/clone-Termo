...
export const Palavras = (palavraParaVerificar) =>{
const palavras = [
...
// Função para verificar se uma palavra está na lista, ignorando acentos
function verificaPalavra(palavra) {
    const palavraSemAcentos = removeAcentos(palavra);
    return palavras.includes(palavraSemAcentos);
}


        return verificaPalavra(palavraParaVerificar);
}